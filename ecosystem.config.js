module.exports = {
  apps: [
    ...
    {
      name: "dummyzomato-backend",
      script: "index.js",
      cwd: "Frontend/DummyZomato/backend",
      env: { MONGO_URI: process.env.ZOMATO_MONGO_URI }
    },
    {
      name: "auth-service",
      script: "index.js",
    ...
    {
      name: "dummyzomato-frontend",
      script: "serve",
      env: {
        PM2_SERVE_PATH: "Frontend/DummyZomato/frontend/dist",
        PM2_SERVE_PORT: 3001,
        PM2_SERVE_SPA: "true"
      }
    }
