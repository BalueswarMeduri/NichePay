...
const handleDisruptionPayout = async (data) => {
  ...
  const subject = `💰 Disruption Payout Triggered - NichePay 🌧️`;
...
The amount has been credited to your NichePay wallet. Thank you for your hard work!`;
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; border: 1px solid #eee; padding: 20px; border-radius: 10px;">
      ...
      <p>The amount has been automatically credited to your NichePay wallet. No manual claim required!</p>
      <p>Stay safe out there! 🛡️</p>
      <hr style="border: none; border-top: 1px solid #eee; margin-top: 20px;">
      <p style="font-size: 12px; color: #888;">NichePay - Parametric Income Protection</p>
    </div>
  `;
