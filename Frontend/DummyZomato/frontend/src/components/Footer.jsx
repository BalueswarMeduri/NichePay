...
const Footer = () => {
  return (
    <footer className="bg-gray-950 text-white pt-24 pb-12 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-16 border-b border-gray-800 pb-16 mb-12">
        <div className="md:col-span-1">
          <span className="text-4xl font-black italic tracking-tighter text-white cursor-default select-none transition hover:text-red-500 duration-500">zomato</span>
        ...
        <div>
          ...
          <div className="flex bg-gray-900 p-2 rounded-2xl border border-gray-800 focus-within:border-red-500 transition-all shadow-inner">
            <input 
              type="text" 
              placeholder="Your email" 
              className="bg-transparent border-none outline-none py-2 px-4 text-white w-full text-sm"
            />
            <button className="bg-red-500 p-3 rounded-xl hover:bg-red-600 transition shadow-lg shadow-red-500/10">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center text-gray-500 text-[13px] gap-8 font-medium">
        <div className="flex gap-8">
          <p>&copy; {new Date().getFullYear()} Zomato Delivery Center Inc.</p>
        ...
        <div className="flex gap-4">
          <a href="#" className="size-12 bg-gray-900 flex items-center justify-center rounded-2xl border border-gray-800 hover:border-red-500/50 hover:bg-red-500/10 hover:text-red-500 transition-all text-xl"><FaFacebook /></a>
          <a href="#" className="size-12 bg-gray-900 flex items-center justify-center rounded-2xl border border-gray-800 hover:border-red-500/50 hover:bg-red-500/10 hover:text-red-500 transition-all text-xl"><FaTwitter /></a>
          <a href="#" className="size-12 bg-gray-900 flex items-center justify-center rounded-2xl border border-gray-800 hover:border-red-500/50 hover:bg-red-500/10 hover:text-red-500 transition-all text-xl"><FaInstagram /></a>
        </div>
      </div>
    </footer>
  );
