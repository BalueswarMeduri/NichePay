    ...
    const steps = [
        {
            number: "01",
            icon: "",
            title: "Connect your Zomato ID",
            description: "Log in with your existing Zomato Delivery Partner ID. No new account, no KYC hassle.",
            why: "Why Zomato ID? We verify you're an active partner and track order data to confirm real income loss — not fake claims."
        },
        {
            number: "02",
            icon: "",
            ...
            why: "Why weekly? Zomato pays weekly. Your insurance should work the same way."
        },
        {
            number: "03",
            icon: "",
