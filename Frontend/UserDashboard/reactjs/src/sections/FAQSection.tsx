    ...
    const faqs = [
        {
            ...
            a: "No! NichePay uses zero-touch parametric insurance. We automatically monitor weather APIs and news sources. When a disruption hits your working zone and halts Zomato deliveries, we verify it and issue the payout automatically. No forms, no calls, no agents."
        },
        {
        ...
        {
            q: "What happens if I decide to take a week off from Zomato?",
            a: "Your NichePay coverage automatically pauses when you're inactive. Our system syncs with your Zomato ID — if you aren't working, you aren't charged, and your coverage simply waits until you start delivering again."
        },
        {
            q: "Can I cancel my plan anytime?",
            a: "Absolutely. We charge on a weekly basis, directly matching how Zomato pays you. There are no sneaky term limits, annual contracts, or hidden exit fees. You can upgrade, downgrade, or cancel your weekly plan instantly from your dashboard."
        }
    ];
    ...
    return (
        <div id="faqs" className="px-4 md:px-16 lg:px-24 xl:px-32 py-24">
            <SectionTitle 
                ...
                text3="Everything you need to know about how NichePay protects your income." 
            />
