...
export const featuresData: IFeature[] = [
    {
        ...
        title: "Zomato ID login",
        description: "No new account needed. Your Zomato Partner ID is your identity on NichePay — we verify your active status automatically.",
    },
    {
    ...
    },
    {
        ...
        description: "Three checks on every claim — Zomato login, disruption data, order activity. Keeps the pool fair for everyone.",
    },
    {
        icon: <Smartphone className="size-8 text-primary-500" strokeWidth={1.5} />,
        title: "Works on any phone",
        description: "No app download needed. NichePay is a PWA — open it in Chrome, tap the WhatsApp link, and you're registered in 2 minutes.",
    },
    {
    ...
    },
    {
        ...
        description: "Pay weekly — not monthly or annually. Aligned with how Zomato pays you, so you never pay from savings.",
    },
    {
        icon: <Lock className="size-8 text-primary-500" strokeWidth={1.5} />,
        title: "Secure & private",
        description: "Your Zomato ID and UPI details are encrypted at rest. We never share your data. Coverage pauses if you go inactive.",
    }
];
