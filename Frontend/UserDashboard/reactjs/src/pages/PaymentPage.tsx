...
export default function PaymentPage() {
    ...
    const plan = location.state?.plan || { name: 'Standard NichePay', price: 149 };
    ...
    const handlePayment = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const partnerData = localStorage.getItem('nichePayUser');
            let partnerId = localStorage.getItem('partnerId') || 'drv_test_123';
            let emailAddress = 'driver@nichepay.com';
            ...
            const response = await fetch('http://16.112.159.224:5002/api/policy/select-plan', {
                method: 'POST',
                ...
                <div className="bg-[#1C1C1E] border border-white/10 shadow-2xl rounded-2xl overflow-hidden flex flex-col">
                    ...
                    <div className="p-6 border-b border-white/5 flex gap-4 items-center">
                        ...
                        <div className="flex flex-col">
                            <span className="text-sm font-semibold text-slate-300 opacity-80">NichePay Coverage</span>
