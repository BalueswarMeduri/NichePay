                    ...
                    >
                        ...
                        >
                            ...
                            <div className="p-8 bg-black/20 h-48 overflow-y-auto text-sm text-slate-300 leading-relaxed space-y-4 font-mono">
                                <p>1. <strong className="text-white">Parametric Logic:</strong> Payouts are exclusively triggered by official environmental data and Zomato delivery halts. No manual claims are honored.</p>
                                <p>2. <strong className="text-white">Deduction Authorization:</strong> By proceeding, you authorize the weekly premium of ₹{selectedPlan !== null ? pricingData[selectedPlan].price : ''} to be automatically factored into your NichePay ledger.</p>
                                <p>3. <strong className="text-white">Active Status Requirement:</strong> Coverage is only valid when your Zomato Delivery ID is actively tracking shifts. Inactive driving weeks will automatically pause coverage and billing.</p>
                            </div>
                            ...
                            <div className="p-8 border-t border-white/10 bg-slate-900">
                                <label className="flex items-start gap-4 mb-6 cursor-pointer group">
                                    ...
                                    <span className="text-sm text-slate-300 group-hover:text-white transition-colors">
                                        I confirm that I have read, understood, and agree to the fully automated terms of NichePay's gig shield coverage.
                                    </span>
                                </label>
